    ...
    return (
        <div className="flex min-h-screen bg-gray-300 pt-20 sm:pt-24 overflow-y-scroll">
            <div className="md:w-1/2 w-full flex flex-col items-center justify-center pl-8">
                ...
                <button
                    type="button"
                    className="md:w-1/3 w-1/2 ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
